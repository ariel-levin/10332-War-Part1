...
public class War {
	...
	public static final int DELAY = 1000;	// the timer delay for each time unit
	...
	/** Prints list of all the alive Iron Domes */
	...
	/** Prints list of all the alive Launcher Destroyers */
