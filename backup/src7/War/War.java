	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (choice) {
				...
				case 6:	
						break;
				case 7:	Statistics.showStatistics();
						break;
				case 8:	endWar();
						break;
		}
...
//		runWarTest();
	...
	private static void inputMissile(Launcher launcherInput) {
		...
		Missile m = new Missile(id,destination,launchTime,flyTime,damage,launcher);
